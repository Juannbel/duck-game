...
TEST(CLIENT_PROTOCOL,_RECV_INITIAL_SNAPSHOT) {
    ...
    EXPECT_EQ(snapshot.game_finished, false) << "game_finished should be equal to the expected game_finished";
    EXPECT_EQ(snapshot.round_finished, false) << "round_finished should be equal to the expected round_finished";
